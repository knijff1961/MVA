...
void setup() {
  ...
  cPreEmptiveTimer1.setWaitConst(LED1_STATE_UP);   // 1 sec
  cPreEmptiveTimer2.iState = 0;
  cPreEmptiveTimer2.setWaitConst(LED2_STATE_UP);   // 700 ms)
  cPreEmptiveTimer3.iState = 0;
  cPreEmptiveTimer3.setWaitConst(LED3_STATE_UP);   // 650 ms)
  cPreEmptiveTimer4.iState = 0;
  cPreEmptiveTimer4.setWaitConst(LED4_STATE_UP);   // 1200 ms)
}
